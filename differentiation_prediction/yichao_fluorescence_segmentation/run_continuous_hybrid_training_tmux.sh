...
SESSION="${1:-yichao_continuous_hybrid_b2f_v1}"
TARGET_ROOT="${2:-${REPO_ROOT}/analysis-outputs/yichao_fluorescence_segmentation_relaxed}"
OUTPUT_ROOT="${3:-${REPO_ROOT}/analysis-outputs/yichao_fluorescence_continuous/runs/soft_suppressed_hybrid_unet_v1}"
