...
DATASET_SOURCES = (
    DatasetSourceSpec(
        name="Data-Yichao-1",
        source_rel="Data-Yichao-1/P11N&N39_Rep_DF_jpeg_all_by_object",
        default_stage="differentiated_irregular",
        default_diameters=(140, 240, 380),
    ),
    DatasetSourceSpec(
        name="Data-Yichao-2",
        source_rel="Data-Yichao-2/P11N&N39_Rep_DF_jpeg_all_by_object",
        default_stage="cystic_early",
        default_diameters=(110, 220, 360),
    ),
    DatasetSourceSpec(
        name="Data-Yichao-3",
        source_rel="Data-Yichao-3/N39_TriRep_DF_jpeg_all_by_position",
        default_stage="fused_large",
        default_diameters=(70, 130, 220),
    ),
    DatasetSourceSpec(
        name="Data-Yichao-4",
        source_rel="Data-Yichao-4/N39_TriRep_DF_2_jpeg_all_by_position",
        default_stage="fused_large",
        default_diameters=(70, 130, 220),
    ),
    DatasetSourceSpec(
    ...
    DatasetSourceSpec(
        name="Data-Yichao-11",
        source_rel="Data-Yichao-11/N39_TriRep_DF_8_jpeg_all_by_position",
        default_stage="fused_large",
        default_diameters=(70, 130, 220),
    ),
)
